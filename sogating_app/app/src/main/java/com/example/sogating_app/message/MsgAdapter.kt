...
class MsgAdapter(val context: Context, val items : MutableList<MsgModel>) : BaseAdapter(){
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        view!!.findViewById<TextView>(R.id.listview_item_nickname).text = items[p0].sendText
        view!!.findViewById<TextView>(R.id.lv_nickname_area).text = items[p0].senderInfo
